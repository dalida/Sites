  ...
  <div class="imagesTabs">
    <div id="TabbedPanels1" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        ...
        <li class="TabbedPanelsTab" tabindex="1">Not Processed</li>
        <li class="TabbedPanelsTab" tabindex="2">Wildlife 1</li>
</ul>
    ...
    <div id="image_caract">
      <table width="88%" align="center">
        <tr>
          ...
          <td><div align="left">Wildlife 1</div></td>
        </tr>
        <tr>
          <th scope="row"><div align="right">Longitude:</div></th>
          <td><div align="left">48.35954</div></td>
        </tr>
        <tr>
          <th scope="row"><div align="right">Latitude:</div></th>
          <td><div align="left">-4.570347</div></td>
        </tr>
        <tr>
          <th scope="row"><div align="right">Altitude:</div></th>
          <td><div align="left">3.568475</div></td>
        </tr>
        <tr>
