<?php class EmailQueueCommand extends CConsoleCommand
{
  public $verbose=false;
  public $checkpoint=false;

  private function log($level,$mesg) {
    Yii::log("EmailQueueCommand",$level,$mesg);
  }
  ...
  public function actionRunEmailQueueByView($view="undefined", $limit=100, $test_email="test@shavacity.com") {
    ...
    $queuemanager->init();
    $emails = EMailQueue::model()->findAllByAttributes(array('view'=>$view,'enabled'=>1,'status'=>'ready'));
