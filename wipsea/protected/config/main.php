...
return array(
	...
	'import'=>array(
		...
		//'application.modules.image.Image.*',
	),
	...
	'components'=>array(
		...
		*/
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=wipsea',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => 'root',
			'charset' => 'utf8',
        ...
        //),
        'image'=>array(
            'class'=>'application.extensions.image.image.CImageComponent',
            'driver'=>'GD',
        ),
	),
